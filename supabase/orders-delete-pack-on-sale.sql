...
-- vender un pack desde Ventas). La venta tambien queda registrada con
-- item_type = 'pack' en vez de 'game' para que se muestre correctamente en
-- Ventas. Si no hay precio de venta cargado, no se borra nada ni se registra
